...
* **Métodos:**
    ...
    * `consultarPorId(id: Integer): Paciente`
    * `consultarPorNome(nome: String): List<Paciente>`
    * `excluir(id: Integer): Boolean`

### 2. ProfissionalDeSaude
* **Atributos:**
    * `id: Integer`
    * `nome: String`
    * `telefone: String`
...
* **Atributos:**
    ...
    * `pacienteId: Integer` (Foreign Key) *(novo)*
...
* **Métodos:**
    ...
    * `consultarPorPaciente(pacienteId: Integer): List<Atendimento>` *(novo)*
    * `excluir(id: Integer): Boolean`
...
* **Paciente (1) --- (*) Atendimento:** *(novo)*
    * Um paciente pode ter múltiplos atendimentos.
    * Um atendimento pertence a exatamente um paciente.
